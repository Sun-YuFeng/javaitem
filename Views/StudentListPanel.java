...
public class StudentListPanel extends JPanel {
    ...
    public StudentListPanel() {
        ...
        btnDelete.addActionListener(e -> {
            ...
            // TODO 删除学生
            new StudentServince().deleteStudent(data[selectedRow][0]);
            try {
                new StudentServince().initStudent();
            } catch (Exception ex) {
            ...
            try {
                ...
                for(int i = 0;i < newStudent.size();i++){
                    newData[i][0] = String.valueOf(newStudent.get(i).getId());
                    newData[i][1] = newStudent.get(i).getName();
                    newData[i][2] = new GroupService().getGroupName(newStudent.get(i).getGroupId());
                }
